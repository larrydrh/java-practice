package shortasr.xunfei.stream;
...
//    private String pcmFile = "/home/rhding/Downloads/Java_iat1021_5f191a21/sample/MscDemo/asr_test.pcm";
    private String pcmFile = "/home/rhding/projects/realtime-asr-java-sdk/audios/sample.raw";
...
//				"./iat_test.pcm");
        ...
        try {
            fis = new FileInputStream(new File(pcmFile));
            if (0 == fis.available()) {
