...
interface MediaInfoLibrary extends Library {
    ...
    MediaInfoLibrary INSTANCE = (MediaInfoLibrary) Native.load("mediainfo", MediaInfoLibrary.class, singletonMap(OPTION_FUNCTION_MAPPER, new FunctionMapper() {
