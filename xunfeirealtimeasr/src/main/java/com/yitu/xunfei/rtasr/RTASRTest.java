...
import com.yitu.xunfei.rtasr.util.EncryptUtil;
...
public class RTASRTest {
    ...
    // appid
    private static final String APPID = "5f191a21";

    // appid对应的secret_key
    private static final String SECRET_KEY = "993437bfd09f161799af7a70fcfd16f3";
    ...
    // 音频文件路径
    private static final String AUDIO_PATH = "/home/rhding/projects/realtime-asr-java-sdk/audios/sample.raw";
        ...
        while (true) {
            ...
            try (RandomAccessFile raf = new RandomAccessFile(AUDIO_PATH, "r")) {
                ...
                while ((len = raf.read(bytes)) != -1) {
                    ...
                    send(client, bytes);
//                    System.out.println(getCurrentTimeStr() + "\t发送40ms");
                    // 每隔40毫秒发送一次数据
                    Thread.sleep(40);
